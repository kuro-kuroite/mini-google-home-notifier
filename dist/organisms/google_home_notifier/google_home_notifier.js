...
var GoogleHomeNotifier =
/*#__PURE__*/
function () {
  function GoogleHomeNotifier(deviceIdentifier) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    _classCallCheck(this, GoogleHomeNotifier);
  ...
  _createClass(GoogleHomeNotifier, [{
    key: "searchDevice",
    value: function searchDevice() {
      ...
      return new _bluebird.default(function (resolve, reject) {
        ...
        browser.on('update', function (service) {
          ...
          console.log("Device ".concat(service.fullname, " at ").concat(address, ":").concat(service.port, " found"));
        ...
        browser.on('error', function (err) {
          browser.stop(); // HACK: Expected the Promise rejection reason to be an Error
          // eslint-disable-next-line prefer-promise-reject-errors
            ...
            switch (_context.prev = _context.next) {
              ...
              case 3:
                return _context.abrupt("return", new _bluebird.default(function (resolve, reject) {
                  (0, _googleTtsApi.default)(message, language || _this2.options.language, 1, 3000).then(function (url) {
